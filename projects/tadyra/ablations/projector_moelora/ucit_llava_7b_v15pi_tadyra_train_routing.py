...
# custom_imports = dict(imports=['projects.tadyra.model.task_adaptive_visual_encoder'])
model = dict(
    type=TaskAdaptiveVisualEncoder,
    visual_encoder=dict(
