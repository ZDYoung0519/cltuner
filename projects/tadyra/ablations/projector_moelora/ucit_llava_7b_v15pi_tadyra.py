...
from peft.tuners.dymorelora import DyMoeLoraConfig
...
from projects.tadyra.model.tadyra_llava import TadyraLLaVAModel
...
model = dict(
    ...
    taa_select_layers=[3,8,23],
    # taa_select_layers=['1-6', '7-12', '13-18', '19-24'],
    taa_add_residual=True,
    taa_loss_ceof=0,
    taa_pretrained_pth=None,
    freeze_projector_bias=True,
)
